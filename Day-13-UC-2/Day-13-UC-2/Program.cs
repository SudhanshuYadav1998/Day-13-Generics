...
class MaxNumCheck
{
    public static double MaxDoubleNumber(double first_value, double second_value, double third_value)
    {
...
class program
{
    static void Main(string[] args)
    {
        ...
        double output = MaxNumCheck.MaxDoubleNumber(1.56, 2.12, 0.72);
